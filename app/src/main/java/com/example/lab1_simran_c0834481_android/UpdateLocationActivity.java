...
public class UpdateLocationActivity extends AppCompatActivity implements OnMapReadyCallback,
        GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        LocationListener {
    private LocationModel saveLocation;
   ...
   private  Marker mCurrLocationMarker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveLocation = (LocationModel) getIntent().getSerializableExtra(Constants.LOCATION_NAME);
        ...
        if (status != ConnectionResult.SUCCESS) { // Google Play Services are not available
            ...
            if (mapFragment != null) {
                mapFragment.getMapAsync(UpdateLocationActivity.this);
            }

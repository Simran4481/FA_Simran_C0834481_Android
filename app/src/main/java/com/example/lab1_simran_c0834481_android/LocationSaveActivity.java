...
public class LocationSaveActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        LocationListener {
    private String currentAddress = "";
    private double latitude, longitude;
    private FusedLocationProviderClient apiforAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (status != ConnectionResult.SUCCESS) { // Google Play Services are not available
            ...
            if (mapFragment != null) {
                mapFragment.getMapAsync(LocationSaveActivity.this);
            }
        ...
        findViewById(R.id.show_favs).setOnClickListener(v->{
            Intent it = new Intent(LocationSaveActivity.this, ViewLocationActivity.class);
            startActivity(it);
        });
    ...
    private void setCurrentLocation() {
        ...
        apiforAddress = LocationServices.getFusedLocationProviderClient(mContext);
        ...
        LocationCallback locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (locationResult != null && locationResult.getLocations().size() > 0) {
                    apiforAddress.removeLocationUpdates(this);
        ...
        apiforAddress.requestLocationUpdates(
                locationRequest,
                locationCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        addressTv.setText("Please click on top navigation button get the current location and tap it");
...
//                saveLocation.setLatitude(latLng.latitude);
//                saveLocation.setLongitude(latLng.longitude);
//                saveLocation.setAddress(userAddress);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", (dialogInterface, i) -> {
                            ...
                            ActivityCompat.requestPermissions(LocationSaveActivity.this,

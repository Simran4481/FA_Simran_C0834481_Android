...
class DBHandler extends SQLiteOpenHelper {
    ...
    public void updateAddress(LocationModel address) {
    ...
    public ArrayList<LocationModel> getFavouritesLocation() {
        // on below line we are creating a
        ...
        if (saveLocation.moveToFirst()) {
            do {
                ...
                locationArray.add(new LocationModel(saveLocation.getString(1),
